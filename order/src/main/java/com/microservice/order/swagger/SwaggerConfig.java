package com.microservice.order.swagger;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo(
                "Endpoints E-commerce Microservice Order",
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.microservice.order.controller"))
